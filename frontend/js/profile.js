    ...
    if (!token) {
        profileContainer.innerHTML = `
            <div style="text-align: center; padding: 20px 0;">
                ...
                <button onclick="location.href='../index.html'" style="background:var(--teal); color:#0b1220; border:none; font-weight:700; padding:10px 24px; border-radius:999px; cursor:pointer;">
                    Sign In Now
                </button>
            </div>
        `;
